...
const MyProfile = () => {
  ...
  const {
    ...
    data: userData,
    refetch,
  } = useQuery(["userprofiledata", user], () =>
    fetch(`https://peaceful-atoll-91971.herokuapp.com/readUserData?email=${user?.email}`).then((res) =>
      res.json()
    )
  );
  ...
  const handleFormsubmit = (e) => {
    ...
    fetch(`https://peaceful-atoll-91971.herokuapp.com/updateuserprofile/${userData._id}`, {
      method: "PUT",
      headers: {
